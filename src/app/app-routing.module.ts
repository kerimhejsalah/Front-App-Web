...
//******************* front-paths****************************//
  ...
  {path:'professionnel',component:ProfessionnelLayoutComponent,canActivate:[GuardProfessionnelGuard],children:[
    ...
    {path:'contactetud',loadChildren:()=>import('./views/professionnel/contact-patientetud/contact-patientetud.module').then(m=>m.ContactPatientetudModule)},
    {path:'formulaires',loadChildren:()=>import('./views/professionnel/monformulaire/monformulaire.module').then(m=>m.MonformulaireModule)},
    {path:'formulairesetud',loadChildren:()=>import('./views/professionnel/monformulairetud/monformulairetud.module').then(m=>m.MonformulairetudModule)},
    {path:'show-forms/:id',loadChildren:()=>import('./views/professionnel/show-forms/show-forms.module').then(m=>m.ShowFormsModule)},
    {path:'show-formsetud/:id',loadChildren:()=>import('./views/professionnel/showformulairetud/showformulairetud.module').then(m=>m.ShowformulairetudModule)},
    ...
    {path:'dossieretud',loadChildren:()=>import('./views/professionnel/dossieretud/dossieretud.module').then(m=>m.DossieretudModule)},
    ...
    {path:'detaildossieretud/:id',loadChildren:()=>import('./views/professionnel/detaildossieretud/detaildossieretud.module').then(m=>m.DetaildossieretudModule)},
    ...
    {path:'preview-detailsetud/:id/:iddoctor/:idpatient',loadChildren:()=>import('./views/professionnel/preview-formdoctor-etud/preview-formdoctor-etud.module').then(m=>m.PreviewFormdoctorEtudModule)},
  ...
  {path:'patient',component:PatientLayoutComponent,canActivate:[GuardPatientGuard],children:[
    ...
    {path:'contactsetud',loadChildren:()=>import('./views/patient/patient-formsetud/patient-formsetud.module').then(m=>m.PatientFormsetudModule)},
    ...
    {path:'forms-detailsetud/:id/:iddoctor/:idpatient',loadChildren:()=>import('./views/patient/forms-detailsetud/forms-detailsetud.module').then(m=>m.FormsDetailsetudModule)},
    ...
    {path:'preview-detailsetud/:id/:iddoctor/:idpatient',loadChildren:()=>import('./views/patient/preview-detailsetud/preview-detailsetud.module').then(m=>m.PreviewDetailsetudModule)},
  ]},
