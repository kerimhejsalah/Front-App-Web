...
@Component({
  selector: 'app-contact-patientetud',
  templateUrl: './contact-patientetud.component.html',
  styleUrls: ['./contact-patientetud.component.css']
})
export class ContactPatientetudComponent implements OnInit {
  id: any;
  contacts:any
  p:number;
  y:number;
  ...
  constructor(private invservice:InvitaionsService,private authPro: AuthProfessionnelService,private PatForms:PatientFormsetudService,private router:Router,) { 
...
/*    GetForms(DocID){
  ...
  async previewForm (form:any){
    ...
    await  this.router.navigate(['professionnel/preview-detailsetud',form,this.id,this.idPatient])
