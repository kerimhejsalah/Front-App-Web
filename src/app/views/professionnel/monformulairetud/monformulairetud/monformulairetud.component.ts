...
import { FormetudService } from '../../../services/professionnel/formetud.service';
import { AffectformetudserviceService} from '../../../services/professionnel/affectformetudservice.service';
...
@Component({
  selector: 'app-monformulairetud',
  templateUrl: './monformulairetud.component.html',
  styleUrls: ['./monformulairetud.component.scss']
})
export class MonformulairetudComponent implements OnInit {
  id: any;
  forms:any;
  formId:any;
  contacts:any;
  ...
  constructor( private PaymentService:PaymentService,private data:FormDataService,private PatForms:PatientFormsService,
    private router:Router,private snackBar:MatSnackBar,private invservice:InvitaionsService,
    private formsService:FormetudService,private authPro: AuthProfessionnelService,
    private formaffectPro:AffectformetudserviceService) { 
    ...
    this.formaffectPro.getAffectation(this.id ).subscribe(response=>{
...
// console.log('resss',res)
    ...
    //  console.log(formId)
    this.router.navigate(['/professionnel/show-formsetud',formId._id])
