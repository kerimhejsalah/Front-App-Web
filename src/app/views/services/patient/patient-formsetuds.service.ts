...
export class PatientFormsetudsService {
...
// all forms
  ...
  console.log(`${this.URL}`+'affectationformetudetopatientgetallform/')
  ...
  getFormsDoctor(id:any,body){
   /*  console.log(2) */
    ...
    const headers=new HttpHeaders().set('authorization','Bearer '+token)
/*   console.log(id,body,"headers",token) */
    return this.http.get<any>(`${this.URL}`+'affectationformetudetopatientgetallform/'+id+'/'+body,{headers: headers})  
