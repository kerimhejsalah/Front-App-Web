...
@Component({
  selector: 'app-forms-detailsetud',
  templateUrl: './forms-detailsetud.component.html',
  styleUrls: ['./forms-detailsetud.component.css']
})
export class FormsDetailsetudComponent implements OnInit  {
...
selectedElement: PeriodicElement;
 ...
 stepsArray:slider.dataRange,  
  ...
  constructor(private data:FormDataService, private authPat:AuthPatientService,private snackBar:MatSnackBar,private PatForms:PatientFormsetudService, private router: ActivatedRoute, private login :LoginService,private route:Router) {
  ...
  /*   console.log('this is add', ) */
      if(res){
        if(localStorage.getItem("langauage")=='fr'){
          this.route.navigate(['/patient/contactsetud'])
